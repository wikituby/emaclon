    ...
    private static void calculateLoan() {
        ...
        switch (loanOption) {
            ...
            case 5 -> {
                ...
                System.out.println("1.Amount to be borrowed is shs:" + calculator.getAmountToBeBorrowed()+" "+" interest paid per day is shs:" + calculator.getInterestToBePaidPerDay()+" "+"  interest paid per Week is shs:" + calculator.getInterestToBePaidPerWeek());
            ...
            case 6 -> {
                ...
                System.out.println("1.interest Rate per Month is:" + calculator.getRatePerMonth());
